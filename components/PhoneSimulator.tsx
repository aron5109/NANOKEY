...
export const PhoneSimulator: React.FC<PhoneSimulatorProps> = ({ children }) => {
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#0a0a0a] p-4">
      {/* Reduced height to 720px to ensure visibility on smaller screens */}
      <div className="relative w-[360px] h-[720px] bg-black rounded-[40px] border-[8px] border-[#222] shadow-[0_0_50px_rgba(0,0,0,0.5)] overflow-hidden flex flex-col box-border">
